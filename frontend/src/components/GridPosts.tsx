    ...
    <ul className="grid gap-4 mx-[20px] grid-cols-1 xsm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-5">
      {posts.map((post) => (
        <li
          ...
          className="group relative flex flex-col justify-between pt-[80%] bg-center bg-cover bg-no-repeat bg-gray-200 rounded-md shadow-xl overflow-hidden text-white transition-all hover:-translate-y-2"
        >
